...
- (void)configureDatePicker:(NSMutableDictionary *)optionsOrNil;
{
	...
	if ( ! allowOldDates) {
		self.datePicker.minimumDate = [NSDate dateWithTimeIntervalSinceNow:(NSTimeInterval)2592000];
        self.datePicker.maximumDate = [NSDate dateWithTimeIntervalSinceNow:(NSTimeInterval)157784630];
